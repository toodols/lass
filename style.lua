...
style_rule_9.Selector = ".a, .b"

local style_rule_10 = Instance.new "StyleRule"
style_rule_10.Parent = style_rule_9
table.insert(style_rules, style_rule_10)
style_rule_10.Selector = ".h, .j"
